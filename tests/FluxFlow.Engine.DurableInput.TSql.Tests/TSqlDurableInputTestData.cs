...
internal static class TSqlDurableInputTestData
{
    ...
    internal static DurableInputEnvelope Envelope(
        ...
        => new(
            address ?? ApplicationAddress.WorkflowPort("Orders", "Receiver", "Input"),
            contractName,
