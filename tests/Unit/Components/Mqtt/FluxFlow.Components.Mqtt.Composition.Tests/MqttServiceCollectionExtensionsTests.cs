...
public sealed class MqttServiceCollectionExtensionsTests
{
    ...
    public void AddMqtt_registers_four_vnext_contracts()
    {
        ...
        AssertFlowValuePort(events.Outputs, MqttComponentDefinition.Ports.Output);
