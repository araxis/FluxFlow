...
public sealed class HealthReadinessConventionTests
{
    ...
    public void Health_integration_package_is_optional_standard_only_and_manifested()
    {
        ...
        ReadProperty(project, "Version").ShouldBe("2.0.0-rc.2");
        ...
        ReadIncludes(project, "ProjectReference")
            .ShouldBe(new[] { @"..\..\Runtime\FluxFlow.Engine\FluxFlow.Engine.csproj" });
        ...
        entry.Project.ShouldBe("src/Engine/Health/FluxFlow.Engine.HealthChecks/FluxFlow.Engine.HealthChecks.csproj");
        entry.NotesName.ShouldBe("FluxFlow.Engine.HealthChecks");
        entry.BinaryCompatibilityBaseline.ShouldBe("1.0.0-rc.1");
