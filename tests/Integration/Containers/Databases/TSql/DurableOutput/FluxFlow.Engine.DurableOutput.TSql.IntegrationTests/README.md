...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File ./tests/Integration/Containers/Databases/TSql/DurableOutput/FluxFlow.Engine.DurableOutput.TSql.IntegrationTests/run-integration.ps1 -AcceptLicense -UseExternalConnectionString
```
