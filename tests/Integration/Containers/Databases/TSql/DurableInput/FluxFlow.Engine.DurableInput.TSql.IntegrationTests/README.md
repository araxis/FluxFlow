...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File ./tests/Integration/Containers/Databases/TSql/DurableInput/FluxFlow.Engine.DurableInput.TSql.IntegrationTests/run-integration.ps1 -AcceptLicense -UseExternalConnectionString
```
