...
public static partial class RoutingComponentDefinition
{
    ...
    public static class Ports { public const string Input = "Input"; public const string Output = "Output"; public const string Left = "Left"; public const string Right = "Right"; }
