...
/// </summary>
public sealed class FlowValueCounterNode : IFlowNode
{
    private const string InputType = nameof(FlowValue);

    private readonly FlowValueCounterOptions _options;
    private readonly IFlowPredicate<FlowValue>? _predicate;
    private readonly string? _engineName;
    private readonly TimeProvider _clock;
    private readonly FlowValueObservabilityPipeline<FlowCounterSnapshot> _pipeline;
    private long _count;
    private long _rejectedCount;

    public FlowValueCounterNode(
        FlowValueCounterOptions options,
        ...
        TimeProvider? clock = null)
    {
        ...
        _pipeline = new FlowValueObservabilityPipeline<FlowCounterSnapshot>(
    ...
    private void PublishEvent(
        ...
        => _pipeline.PublishEvent(new FlowEvent
        {
            ...
            Attributes = new Dictionary<string, object?>(StringComparer.Ordinal)
            {
                ...
                ["isError"] = isError,
                ["name"] = _options.EffectiveName,
                ["nodeType"] = FlowCounterNode<FlowValue>.NodeType,
                ["rejectedCount"] = rejectedCount,
                ["resultKind"] = resultKind
            }
        });

    private static FlowValueCounterOptions ValidateOptions(
        FlowValueCounterOptions? options)
    {
