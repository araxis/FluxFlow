...
public sealed class ApplicationPorts
{
    ...
    public ISourceBlock<FlowMessage> SystemEvents => Runtime.SystemEvents;

    public ISourceBlock<FlowMessage> Diagnostics => Runtime.Diagnostics;

    public ISourceBlock<FlowMessage> Activity => Runtime.Activity;
