...
public sealed class FluxFlowApplication : IAsyncDisposable
{
    ...
    /// <summary>
    /// Application-lifetime canonical events, including events before activation and across revisions.
    /// Use native LinkTo predicates. Delivery is observational: bounded ingress and slow targets can lose events.
    /// History, metrics and reports belong to the consumer. The source completes when the application stops.
    /// </summary>
    public ISourceBlock<FlowMessage> Events => _assembler.Events.Events;
