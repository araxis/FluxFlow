...
{
    public static ComponentContract<EventProjectionComponentBuilder, InputOutputComponentHandle<FlowValue, FlowValue>> EventProjection { get; } =
        DesignedComponentContract.Create(
            ...
            static component => new InputOutputComponentHandle<FlowValue, FlowValue>(component, ProjectionsComponentDefinition.Ports.Input, ProjectionsComponentDefinition.Ports.Output, ProjectionsComponentDefinition.Ports.Events));
}

public static class ProjectionsAuthoringExtensions
{
    public static InputOutputComponentHandle<FlowValue, FlowValue> AddEventProjection(
    ...
    public static WorkflowDefinitionBuilder AddEventProjection(
        this WorkflowDefinitionBuilder workflow,
        string name,
        out InputOutputComponentHandle<FlowValue, FlowValue> projection)
    {
