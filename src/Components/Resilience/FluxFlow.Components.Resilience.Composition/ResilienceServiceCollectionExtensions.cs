...
public static class ResilienceServiceCollectionExtensions
{
    ...
    internal static void ConfigureRetry(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(ResilienceComponentDefinition.Ports.Input, static node => node.Input, FlowValueShape.Any("Any workflow value that begins a retry-controlled logical operation."), "Input", "Messages", 0, "Value that begins a retry-controlled logical operation.", true)
            ...
            .HasFlowValueOutput(ResilienceComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 4, "Attempt, scheduled retry, completion, exhaustion, cancellation, or rejection result.", true)
    ...
    private static FlowValueRetryNode CreateFlowRetryNode(
