...
{
    public static ComponentContract<StateReducerComponentBuilder, InputOutputComponentHandle<FlowValue, FlowValue>> StateReducer { get; } =
        DesignedComponentContract.Create(
            ...
            static component => new InputOutputComponentHandle<FlowValue, FlowValue>(component, StateComponentDefinition.Ports.Input, StateComponentDefinition.Ports.Output, StateComponentDefinition.Ports.Events));
}

public static class StateAuthoringExtensions
{
    public static InputOutputComponentHandle<FlowValue, FlowValue> AddStateReducer(
    ...
    public static WorkflowDefinitionBuilder AddStateReducer(
        ...
        string name,
        Action<StateReducerComponentBuilder> configure,
        out InputOutputComponentHandle<FlowValue, FlowValue> reducer)
    {
