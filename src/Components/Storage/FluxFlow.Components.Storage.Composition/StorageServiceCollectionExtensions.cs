...
public static class StorageServiceCollectionExtensions
{
    ...
    internal static void ConfigurePut(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(StorageComponentDefinition.Ports.Input, static node => node.Input, new FluxFlow.Components.Storage.Materialization.StorageContentPutRequestMaterializer().InputShape, "Input", "Messages", 0, "Exact-content storage put request.", true)
            .HasFlowValueOutput(StorageComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "Stored or failed operation result.", true)
    ...
    internal static void ConfigureGet(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(StorageComponentDefinition.Ports.Input, static node => node.Input, new FluxFlow.Components.Storage.Materialization.StorageGetRequestMaterializer().InputShape, "Input", "Messages", 0, "Storage get request.", true)
            .HasFlowValueOutput(StorageComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "Found, missing, or failed operation result.", true)
    ...
    internal static void ConfigureQuery(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(StorageComponentDefinition.Ports.Input, static node => node.Input, new FluxFlow.Components.Storage.Materialization.StorageQueryRequestMaterializer().InputShape, "Input", "Messages", 0, "Storage query request.", true)
            .HasFlowValueOutput(StorageComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "Completed or failed storage query result.", true)
    ...
    internal static void ConfigureDelete(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(StorageComponentDefinition.Ports.Input, static node => node.Input, new FluxFlow.Components.Storage.Materialization.StorageDeleteRequestMaterializer().InputShape, "Input", "Messages", 0, "Storage delete request.", true)
            .HasFlowValueOutput(StorageComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "Deleted, missing, or failed operation result.", true)
