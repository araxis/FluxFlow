...
public static class MqttServiceCollectionExtensions
{
    ...
    internal static void ConfigureControl(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(MqttComponentDefinition.Ports.Input, static node => node.Input, new MqttClientRequestMaterializer().InputShape, "Input", "Messages", 0, "Input message.", true)
            .HasFlowValueOutput(MqttComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "Operation result.", true)
            .HasEvents(MqttComponentDefinition.Ports.Events, static node => node.Events, "Events", "Diagnostics", 2, "Best-effort MQTT command diagnostics.", eventShapes: MqttEventDesignMetadata.Command);
    }
    ...
    internal static void ConfigurePublish(ComponentRegistrationBuilder component)
    {
        ...
        ConfigureCommon(component, "MQTT Publish", "Materializes a workflow value and publishes it through a logical client.", "send", "publishMqtt", 420);
        ...
        component
            ...
            .HasFlowValueInput(MqttComponentDefinition.Ports.Input, static node => node.Input, new MqttPublishMessageMaterializer().InputShape, "Input", "Messages", 0, "Input message.", true)
            .HasFlowValueOutput(MqttComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "Operation result.", true)
            .HasEvents(MqttComponentDefinition.Ports.Events, static node => node.Events, "Events", "Diagnostics", 2, "Best-effort MQTT publish diagnostics.", eventShapes: MqttEventDesignMetadata.Publish);
    }
    ...
    internal static void ConfigureTrigger(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueOutput(MqttComponentDefinition.Ports.Output, static node => node.Output, "Output", "Messages", 2, "Received MQTT application message.", true)
            .HasEvents(MqttComponentDefinition.Ports.Events, static node => node.Events, "Events", "Diagnostics", 3, "Best-effort MQTT receive diagnostics.", eventShapes: MqttEventDesignMetadata.Receive);
    }
    ...
    internal static void ConfigureEvents(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueOutput(MqttComponentDefinition.Ports.Output, static node => node.Output, "Output", "Events", 0, "Logical MQTT client lifecycle event.", true)
