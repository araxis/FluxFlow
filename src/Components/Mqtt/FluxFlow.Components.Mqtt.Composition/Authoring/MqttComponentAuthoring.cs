...
public sealed class MqttCommandHandle : MqttComponentHandle
{
    ...
    {
        Input = definition.Input<FlowValue>(MqttComponentDefinition.Ports.Input);
        Output = definition.Output<FlowValue>(MqttComponentDefinition.Ports.Output);
        Events = definition.Output<global::FluxFlow.Data.FlowValue>(MqttComponentDefinition.Ports.Events);
    }
