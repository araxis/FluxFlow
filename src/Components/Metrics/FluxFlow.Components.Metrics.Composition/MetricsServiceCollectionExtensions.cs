...
public static class MetricsServiceCollectionExtensions
{
    ...
    internal static void ConfigureAggregate(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(MetricsComponentDefinition.Ports.Input, static node => node.Input, new FluxFlow.Components.Metrics.Materialization.MetricSampleInputMaterializer().InputShape, "Input", "Messages", 0, "Metric sample to aggregate.", true)
            .HasFlowValueOutput(MetricsComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "Metric aggregate snapshot or expected aggregation failure.", true)
