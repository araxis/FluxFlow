...
/// <summary>
/// Records exact <see cref="FlowContent"/> values and emits normal operation results.
/// </summary>
public sealed class SessionRecorderNode : IFlowNode
{
        ...
        TimeProvider? clock = null)
    {
        ...
        _pipeline = new(
            ...
            _clock,
            new Materialization.SessionContentRecordInputMaterializer(),
            "session.recorder.rejected",
            ProcessAsync,
