...
public static class SessionsServiceCollectionExtensions
{
    ...
    internal static void ConfigureRecorder(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(SessionsComponentDefinition.Ports.Input, static node => node.Input, new FluxFlow.Components.Sessions.Materialization.SessionContentRecordInputMaterializer().InputShape, "Input", "Messages", 0, "Exact-content session record input.", true)
            .HasFlowValueOutput(SessionsComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "Stored or failed session record result.", true)
    ...
    internal static void ConfigureReplay(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueOutput(SessionsComponentDefinition.Ports.Output, static node => node.Output, "Output", "Messages", 0, "Replayed record or normal replay failure result.", true)
    ...
    internal static void ConfigureQuery(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(SessionsComponentDefinition.Ports.Input, static node => node.Input, new FluxFlow.Components.Sessions.Materialization.SessionQueryRequestMaterializer().InputShape, "Input", "Messages", 0, "Session query request.", true)
            .HasFlowValueOutput(SessionsComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "Completed or failed session query result.", true)
