...
public static class RoutingServiceCollectionExtensions
{
    ...
    internal static void ConfigureWindow(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(RoutingComponentDefinition.Ports.Input, static node => node.Input, FlowValueMaterializers.JsonElement.InputShape, "Input", "Messages", 0, "Schema-less JSON value.", true)
            .HasFlowValueOutput(RoutingComponentDefinition.Ports.Output, static node => node.Output, "Output", "Messages", 1, "Count-, time-, or completion-based window; failures use the message error case.", true)
    ...
    internal static void ConfigureCorrelation(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(RoutingComponentDefinition.Ports.Input, static node => node.Input, FlowValueMaterializers.JsonElement.InputShape, "Input", "Messages", 0, "Schema-less JSON request or response value.", true)
            .HasFlowValueOutput(RoutingComponentDefinition.Ports.Output, static node => node.Output, "Output", "Messages", 1, "Match or timeout outcome; failures use the message error case.", true)
    ...
    internal static void ConfigureJoin(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(RoutingComponentDefinition.Ports.Left, static node => node.Left, FlowValueMaterializers.JsonElement.InputShape, "Left", "Messages", 0, "Schema-less JSON left value.", true)
            .HasFlowValueInput(RoutingComponentDefinition.Ports.Right, static node => node.Right, FlowValueMaterializers.JsonElement.InputShape, "Right", "Messages", 1, "Schema-less JSON right value.")
            .HasFlowValueOutput(RoutingComponentDefinition.Ports.Output, static node => node.Output, "Output", "Messages", 2, "Match or timeout outcome; failures use the message error case.", true)
