...
{
    public static ComponentContract<WindowComponentBuilder, InputOutputComponentHandle<FlowValue, FlowValue>> Window { get; } =
        DesignedComponentContract.Create(
            ...
            static component => new InputOutputComponentHandle<FlowValue, FlowValue>(component, RoutingComponentDefinition.Ports.Input, RoutingComponentDefinition.Ports.Output, RoutingComponentDefinition.Ports.Events));

    public static ComponentContract<CorrelationComponentBuilder, InputOutputComponentHandle<FlowValue, FlowValue>> Correlation { get; } =
        DesignedComponentContract.Create(
    ...
    public static ComponentContract<JoinComponentBuilder, DualInputOutputComponentHandle<FlowValue, FlowValue, FlowValue>> Join { get; } =
        DesignedComponentContract.Create(
            RoutingComponentDefinition.Types.Join,
            RoutingServiceCollectionExtensions.ConfigureJoin,
            static () => new JoinComponentBuilder(),
            static (options, definition) => options.Apply(definition),
            static component => new DualInputOutputComponentHandle<FlowValue, FlowValue, FlowValue>(component, RoutingComponentDefinition.Ports.Left, RoutingComponentDefinition.Ports.Right, RoutingComponentDefinition.Ports.Output, RoutingComponentDefinition.Ports.Events));
}

public static class RoutingAuthoringExtensions
{
    public static InputOutputComponentHandle<FlowValue, FlowValue> AddWindow(
    ...
    public static WorkflowDefinitionBuilder AddWindow(
        ...
        string name,
        Action<WindowComponentBuilder> configure,
        out InputOutputComponentHandle<FlowValue, FlowValue> window)
    {
        window = workflow.AddWindow(name, configure);
        return workflow;
    }

    public static InputOutputComponentHandle<FlowValue, FlowValue> AddCorrelation(
        this WorkflowDefinitionBuilder workflow,
        string name,
    ...
    public static WorkflowDefinitionBuilder AddCorrelation(
        ...
        string name,
        Action<CorrelationComponentBuilder> configure,
        out InputOutputComponentHandle<FlowValue, FlowValue> correlation)
    {
        correlation = workflow.AddCorrelation(name, configure);
        return workflow;
    }

    public static DualInputOutputComponentHandle<FlowValue, FlowValue, FlowValue> AddJoin(
        this WorkflowDefinitionBuilder workflow,
        string name,
    ...
    public static WorkflowDefinitionBuilder AddJoin(
        ...
        string name,
        Action<JoinComponentBuilder> configure,
        out DualInputOutputComponentHandle<FlowValue, FlowValue, FlowValue> join)
    {
