...
{
    public static ComponentContract<JsonSchemaValidatorComponentBuilder, InputOutputComponentHandle<FlowValue, FlowValue>> JsonSchemaValidator { get; } =
        DesignedComponentContract.Create(
            ...
            static component => new InputOutputComponentHandle<FlowValue, FlowValue>(component, ValidationComponentDefinition.Ports.Input, ValidationComponentDefinition.Ports.Output, ValidationComponentDefinition.Ports.Events));
}

public static class ValidationAuthoringExtensions
{
    public static InputOutputComponentHandle<FlowValue, FlowValue> AddJsonSchemaValidator(
    ...
    public static WorkflowDefinitionBuilder AddJsonSchemaValidator(
        this WorkflowDefinitionBuilder workflow,
        string name,
        out InputOutputComponentHandle<FlowValue, FlowValue> validator)
    {
