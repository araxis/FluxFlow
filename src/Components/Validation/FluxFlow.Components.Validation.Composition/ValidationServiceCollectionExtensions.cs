...
public static class ValidationServiceCollectionExtensions
{
    ...
    internal static void ConfigureJsonSchemaValidator(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(ValidationComponentDefinition.Ports.Input, static node => node.Input, FlowValueMaterializers.JsonElement.InputShape, "Input", "Messages", 0, "Immutable workflow value to validate.", true)
            .HasFlowValueOutput(ValidationComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "Normal valid, invalid, or processing-failure result.", true)
