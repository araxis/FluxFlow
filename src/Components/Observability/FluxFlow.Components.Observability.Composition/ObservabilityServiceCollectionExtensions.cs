...
public static class ObservabilityServiceCollectionExtensions
{
    ...
    internal static void ConfigureCounter(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(ObservabilityComponentDefinition.Ports.Input, static node => node.Input, FlowValueMaterializers.JsonElement.InputShape, "Input", "Messages", 0, "JSON value to count.", true)
            .HasFlowValueOutput(ObservabilityComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "Current counter snapshot or workflow error.", true)
    ...
    internal static void ConfigureLogger(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(ObservabilityComponentDefinition.Ports.Input, static node => node.Input, FlowValueMaterializers.JsonElement.InputShape, "Input", "Messages", 0, "JSON value to log.", true)
            .HasFlowValueOutput(ObservabilityComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "Structured log entry or workflow error.", true)
    ...
    internal static void ConfigureMetrics(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(ObservabilityComponentDefinition.Ports.Input, static node => node.Input, FlowValueMaterializers.JsonElement.InputShape, "Input", "Messages", 0, "JSON value to observe.", true)
            .HasFlowValueOutput(ObservabilityComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "Metric snapshot or workflow error.", true)
