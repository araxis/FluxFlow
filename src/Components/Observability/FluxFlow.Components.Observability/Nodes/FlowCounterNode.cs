...
{
    private readonly CanonicalObservabilityNode<FlowCounterSnapshot> _inner;
    ...
    {
        var operation = new FlowCounterNode<JsonElement>(
            options,
            expressionEngine,
            contextFactory,
            clock);
        _inner = new CanonicalObservabilityNode<FlowCounterSnapshot>(
            operation,
            operation.Input,
            operation.Output,
            operation.Events,
