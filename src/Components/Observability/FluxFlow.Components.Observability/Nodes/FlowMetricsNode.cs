...
{
    private readonly CanonicalObservabilityNode<FlowMetricSnapshot> _inner;
    ...
    {
        var operation = new FlowMetricsNode<JsonElement>(options, sizeSelector, clock);
        _inner = new CanonicalObservabilityNode<FlowMetricSnapshot>(
            operation,
            operation.Input,
            operation.Output,
            operation.Events,
