...
public static class SourcesServiceCollectionExtensions
{
    ...
    internal static void ConfigureGenerated(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueOutput(SourcesComponentDefinition.Ports.Output, static node => node.Output, "Output", "Messages", 0, "Generated JSON value.", true)
    ...
    internal static void ConfigureSequence(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueOutput(SourcesComponentDefinition.Ports.Output, static node => node.Output, "Output", "Messages", 0, "Numeric sequence item.", true)
