...
{
    public static ComponentContract<PayloadInspectionComponentBuilder, InputOutputComponentHandle<FlowValue, FlowValue>> PayloadInspection { get; } =
        DesignedComponentContract.Create(
            ...
            static component => new InputOutputComponentHandle<FlowValue, FlowValue>(component, PayloadsComponentDefinition.Ports.Input, PayloadsComponentDefinition.Ports.Output, PayloadsComponentDefinition.Ports.Events));
}

public static class PayloadsAuthoringExtensions
{
    public static InputOutputComponentHandle<FlowValue, FlowValue> AddPayloadInspection(
    ...
    public static WorkflowDefinitionBuilder AddPayloadInspection(
        this WorkflowDefinitionBuilder workflow,
        string name,
        out InputOutputComponentHandle<FlowValue, FlowValue> inspection)
    {
