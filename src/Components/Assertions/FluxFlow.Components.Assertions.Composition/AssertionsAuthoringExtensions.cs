...
{
    public static ComponentContract<AssertionComponentBuilder, InputOutputComponentHandle<FlowValue, FlowValue>> Assertion { get; } =
        DesignedComponentContract.Create(
            ...
            static component => new InputOutputComponentHandle<FlowValue, FlowValue>(component, AssertionsComponentDefinition.Ports.Input, AssertionsComponentDefinition.Ports.Output, AssertionsComponentDefinition.Ports.Events));
}

public static class AssertionsAuthoringExtensions
{
    public static InputOutputComponentHandle<FlowValue, FlowValue> AddAssertion(
    ...
    public static WorkflowDefinitionBuilder AddAssertion(
        ...
        string name,
        Action<AssertionComponentBuilder> configure,
        out InputOutputComponentHandle<FlowValue, FlowValue> assertion)
    {
