...
public static class FileSystemServiceCollectionExtensions
{
    ...
    internal static void ConfigureRead(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(FileSystemComponentDefinition.Ports.Input, static node => node.Input, new FluxFlow.Components.FileSystem.Materialization.FileReadRequestMaterializer().InputShape, "Input", "Messages", 0, "File read request.", true)
            .HasFlowValueOutput(FileSystemComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "File content; read failures use the message error case.", true)
    ...
    internal static void ConfigureWrite(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueInput(FileSystemComponentDefinition.Ports.Input, static node => node.Input, new FluxFlow.Components.FileSystem.Materialization.FileContentWriteRequestMaterializer().InputShape, "Input", "Messages", 0, "File content write request.", true)
            .HasFlowValueOutput(FileSystemComponentDefinition.Ports.Output, static node => node.Output, "Output", "Results", 1, "File write receipt; write failures use the message error case.", true)
    ...
    internal static void ConfigureDirectoryEnumerate(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueOutput(FileSystemComponentDefinition.Ports.Output, static node => node.Output, "Output", "Messages", 0, "Directory entry.", true)
    ...
    internal static void ConfigureWatch(ComponentRegistrationBuilder component)
    {
        ...
        component
            ...
            .HasFlowValueOutput(FileSystemComponentDefinition.Ports.Output, static node => node.Output, "Output", "Messages", 0, "File change event.", true)
