...
public sealed class FlowValueComponentInputPort : ComponentInputPort
{
    public FlowValueComponentInputPort(string name, ITargetBlock<FlowMessage> target)
        : base(name, typeof(global::FluxFlow.Data.FlowValue))
    {
        Target = target ?? throw new ArgumentNullException(nameof(target));
    }

    public ITargetBlock<FlowMessage> Target { get; }
