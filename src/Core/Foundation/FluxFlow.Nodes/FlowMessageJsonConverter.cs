...
internal sealed class FlowMessageJsonConverter : JsonConverter<FlowMessage>
{
    public override FlowMessage Read(
        ...
        JsonSerializerOptions options)
    {
        ...
        return FlowMessage.Rehydrate(
            false,
            FlowValue.FromJson(valueElement),
            error: null,
            correlationId,
            traceId,
            messageId,
