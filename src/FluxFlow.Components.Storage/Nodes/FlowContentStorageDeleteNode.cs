...
/// </summary>
public sealed class FlowContentStorageDeleteNode : IFlowNode
{
    ...
    public FlowContentStorageDeleteNode(
        IStorageStore store,
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var request = StorageContentNodeSupport.NormalizeRequest(
                "delete",
                () => StorageContentNodeSupport.NormalizeDelete(input, _options.Collection));
